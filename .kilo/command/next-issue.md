...
9. Proceed with the issue-specific workflow:
   - docs/config-only issues: make the scoped change and run available non-Mix checks.
   - behavior changes: load the RGR skills and follow RED-GREEN-REFACTOR with specialist agents.
